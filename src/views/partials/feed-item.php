  ...
  <div class="box-body">
    <div class="feed-item-head row mt-20 m-width-20">
      <div class="feed-item-head-photo">
        <a href=""><img src="<?= $base . '/media/avatars/' . $feed->user->avatar ?>" /></a>
      </div>
      <div class="feed-item-head-info">
        <a href=""><span class="fidi-name"><?= $feed->user->name ?></span></a>
        ...
        <br />
        <span class="fidi-date"><?= date('d/m/Y', strtotime($feed->created_at)) ?></span>
      </div>
